...
- [ ] **Tarea 1: Definir estructura del nodo del árbol**
...
- [ ] **Tarea 2: Implementar construcción del árbol**
...
- [ ] **Tarea 3: Implementar actualización de rango con lazy**
...
- [ ] **Tarea 4: Implementar consulta de longitud cubierta**
...
- [ ] **Tarea 5: Integrar con compresión de coordenadas**
...
- [ ] **Tarea 6: Documentar uso público**
